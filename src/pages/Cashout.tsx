...
const Cashout = () => {
  ...
  const totalSteps = 17; // Service selection (step 1) + 16 form steps
  ...
  const handleFormSubmit = async (formData: any) => {
    ...
    const success = await submitLead("Cash Out", enrichedFormData, tokens, false);
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Turn your home equity into cash for renovations, debt
