import React, { useEffect } from "react";
  ...
  import { useOmnisend } from "@/hooks/useOmnisend";
  ...
  const providers = [
    ...
    {
      id: "lendingtree-home-equity",
      name: "LendingTree",
      title: "Unlock Your Home Equity with LendingTree",
      description: [
        "LendingTree connects homeowners with multiple lenders competing for their business",
        "Compare home equity loan and HELOC rates side by side",
        "Free, no-obligation quotes in minutes",
        "Trusted marketplace with 20+ years helping homeowners save",
      ],
      baseUrl: "https://hefty.cc/api/offers/click?offer_id=20",
      logo: null,
      logoColor: "green",
    },
  ];
          ...
          <Card className="mb-6 card-elegant shadow-2xl border-0 overflow-hidden relative">
            ...
            <CardContent className="space-y-3 pb-7 px-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
              ...
              <p className="text-muted-foreground leading-relaxed text-center text-sm max-w-xl mx-auto">
                Someone from MortgageCo will call you soon to discuss your
                application and guide you through the next steps.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="mb-6 card-elegant shadow-2xl border-0 overflow-hidden relative">
            ...
            <CardHeader className="text-center pb-4 pt-6 bg-gradient-to-b from-background to-muted/30">
              <CardTitle className="text-lg md:text-xl font-bold text-primary mb-2">
                Based on your information, we have matched you with the following
                professionals in your area:
              </CardTitle>
              <p className="text-xs text-muted-foreground font-medium">
                We highly recommend comparing quotes from all providers.
              </p>
            </CardHeader>
                    ...
                    <div className="flex-shrink-0 flex items-center justify-center sm:justify-start w-full sm:w-auto">
                      <div className="w-28 h-16 bg-white rounded-md flex items-center justify-center border-2 border-gray-200 p-2 group-hover:border-gray-300 group-hover:shadow-md transition-all duration-300">
                        {provider.logo ? (
                          ...
                          />
                        ) : (provider as any).logoColor === "green" ? (
                          <div className="flex items-center gap-1.5">
                            <TreePine className="w-6 h-6 text-green-600" />
                            <span className="text-sm font-bold text-green-700">LendingTree</span>
                          </div>
                        ) : (
